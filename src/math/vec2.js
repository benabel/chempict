 ...
 *
 * Vec2 objects inherit from MathCoordinate and may be used wherever a
...
goog.inherits(goog.math.Vec2, MathCoordinate);
 ...
 * @param {!MathCoordinate} a The coordinate.
...
goog.math.Vec2.prototype.scale =
    ...
    (MathCoordinate.prototype.scale);
 ...
 * @param {!MathCoordinate} b The vector to add.
 ...
 * @param {!MathCoordinate} b The vector to subtract.
 ...
 * @param {!MathCoordinate} a The first vector.
 * @param {!MathCoordinate} b The second vector.
 * @return {number} The distance.
 */
goog.math.Vec2.distance = MathCoordinate.distance;
 ...
 */
goog.math.Vec2.squaredDistance = MathCoordinate.squaredDistance;
 ...
 */
goog.math.Vec2.equals = MathCoordinate.equals;
 ...
 * scale-value x.
 * @param {!MathCoordinate} a Vector a.
 * @param {!MathCoordinate} b Vector b.
