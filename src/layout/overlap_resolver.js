...
layoutOverlapResolver.displace = function(molecule, overlappingAtoms) {
  ...
  do {
    ...
    if (p >= overlappingAtoms.length) p = overlappingAtoms.length - 1;
    ...
    if (op !== undefined) {
      ...
      alert(
          'problem layoutOverlapResolver.displace p is ' + p + ' and len ' +
          overlappingAtoms.length + ' and ' + op);
    }
